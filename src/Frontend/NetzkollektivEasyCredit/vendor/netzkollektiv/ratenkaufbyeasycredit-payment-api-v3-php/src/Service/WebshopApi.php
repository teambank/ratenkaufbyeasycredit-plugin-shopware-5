...
class WebshopApi
{
    ...
    /**
     * Operation apiPaymentV3WebshopWebshopIdGetAsync
     *
     * Get the necessary information about the webshop
     *
     * @param  string $webshopId Identifier of a webshop (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentV3WebshopWebshopIdGetAsync($webshopId)
    {
        return $this->apiPaymentV3WebshopWebshopIdGetAsyncWithHttpInfo($webshopId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiPaymentV3WebshopWebshopIdGetAsyncWithHttpInfo
     *
     * Get the necessary information about the webshop
     *
     * @param  string $webshopId Identifier of a webshop (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentV3WebshopWebshopIdGetAsyncWithHttpInfo($webshopId)
    {
        $returnType = '\Teambank\RatenkaufByEasyCreditApiV3\Model\WebshopResponse';
        $request = $this->apiPaymentV3WebshopWebshopIdGetRequest($webshopId);

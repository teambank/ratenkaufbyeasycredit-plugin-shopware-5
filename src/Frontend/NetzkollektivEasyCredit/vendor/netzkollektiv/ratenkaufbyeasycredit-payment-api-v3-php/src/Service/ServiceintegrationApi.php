...
/**
 * ServiceintegrationApi Class Doc Comment
 *
 * @category Class
 * @package  Teambank\RatenkaufByEasyCreditApiV3
 * @author   OpenAPI Generator team
...
class ServiceintegrationApi
{
    ...
    /**
     * Operation apiPaymentSiV3IdentityPostAsync
     *
     * create an identity token (device ident ID) which must be used in the payment process
     *
     *
     ...
     */
    public function apiPaymentSiV3IdentityPostAsync()
    {
        return $this->apiPaymentSiV3IdentityPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiPaymentSiV3IdentityPostAsyncWithHttpInfo
     *
     * create an identity token (device ident ID) which must be used in the payment process
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3IdentityPostAsyncWithHttpInfo()
    {
        $returnType = '\Teambank\RatenkaufByEasyCreditApiV3\Model\DeviceIdentToken';
        $request = $this->apiPaymentSiV3IdentityPostRequest();
    ...
    /**
     * Operation apiPaymentSiV3TransactionPreAuthorizationPostAsync
     *
     * preAuthorizes a transaction
     *
     * @param  \Teambank\RatenkaufByEasyCreditApiV3\Model\TransactionSI $transactionSI preAuthorization request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionPreAuthorizationPostAsync($transactionSI = null)
    {
        return $this->apiPaymentSiV3TransactionPreAuthorizationPostAsyncWithHttpInfo($transactionSI)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiPaymentSiV3TransactionPreAuthorizationPostAsyncWithHttpInfo
     *
     * preAuthorizes a transaction
     *
     * @param  \Teambank\RatenkaufByEasyCreditApiV3\Model\TransactionSI $transactionSI preAuthorization request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionPreAuthorizationPostAsyncWithHttpInfo($transactionSI = null)
    {
        $returnType = '\Teambank\RatenkaufByEasyCreditApiV3\Model\TransactionInitResponse';
        $request = $this->apiPaymentSiV3TransactionPreAuthorizationPostRequest($transactionSI);
    ...
    public function apiPaymentSiV3TransactionPreAuthorizationPostRequest($transactionSI = null)
    {
        ...
        if (isset($transactionSI)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($transactionSI));
            } else {
    ...
    /**
     * Operation apiPaymentSiV3TransactionTechnicalTransactionIdGetAsync
     *
     * Get the necessary information about the transaction
     *
     * @param  string $technicalTransactionId Unique TeamBank transaction identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionTechnicalTransactionIdGetAsync($technicalTransactionId)
    {
        return $this->apiPaymentSiV3TransactionTechnicalTransactionIdGetAsyncWithHttpInfo($technicalTransactionId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiPaymentSiV3TransactionTechnicalTransactionIdGetAsyncWithHttpInfo
     *
     * Get the necessary information about the transaction
     *
     * @param  string $technicalTransactionId Unique TeamBank transaction identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionTechnicalTransactionIdGetAsyncWithHttpInfo($technicalTransactionId)
    {
        $returnType = '\Teambank\RatenkaufByEasyCreditApiV3\Model\TransactionInformation';
        $request = $this->apiPaymentSiV3TransactionTechnicalTransactionIdGetRequest($technicalTransactionId);
    ...
    /**
     * Operation apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostAsync
     *
     * transmit the customers mtan
     *
     * @param  string $technicalTransactionId Unique TeamBank transaction identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostAsync($technicalTransactionId, $transmitMtan = null)
    {
        return $this->apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostAsyncWithHttpInfo($technicalTransactionId, $transmitMtan)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostAsyncWithHttpInfo
     *
     * transmit the customers mtan
     *
     * @param  string $technicalTransactionId Unique TeamBank transaction identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostAsyncWithHttpInfo($technicalTransactionId, $transmitMtan = null)
    {
        $returnType = '\Teambank\RatenkaufByEasyCreditApiV3\Model\MTan';
        $request = $this->apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostRequest($technicalTransactionId, $transmitMtan);
    ...
    public function apiPaymentSiV3TransactionTechnicalTransactionIdMtanPostRequest($technicalTransactionId, $transmitMtan = null)
    {
        ...
        if (isset($transmitMtan)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($transmitMtan));
            } else {
    ...
    /**
     * Operation apiPaymentSiV3TransactionTechnicalTransactionIdMtanResendPostAsync
     *
     * send new mtan to customer
     *
     * @param  string $technicalTransactionId Unique TeamBank transaction identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionTechnicalTransactionIdMtanResendPostAsync($technicalTransactionId)
    {
        return $this->apiPaymentSiV3TransactionTechnicalTransactionIdMtanResendPostAsyncWithHttpInfo($technicalTransactionId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiPaymentSiV3TransactionTechnicalTransactionIdMtanResendPostAsyncWithHttpInfo
     *
     * send new mtan to customer
     *
     * @param  string $technicalTransactionId Unique TeamBank transaction identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentSiV3TransactionTechnicalTransactionIdMtanResendPostAsyncWithHttpInfo($technicalTransactionId)
    {
        $returnType = '';
        $request = $this->apiPaymentSiV3TransactionTechnicalTransactionIdMtanResendPostRequest($technicalTransactionId);
